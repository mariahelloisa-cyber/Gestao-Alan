...
import { Shield, ShieldCheck, User, Mail, Clock, Power, Trash2 } from "lucide-react";
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    onClick={() => onToggleStatus(m.id, inativo ? "ativo" : "inativo")}
                  >
                    Confirmar
                  </AlertDialogAction>
                </AlertDialogFooter>
...
export function MembersView() {
  ...
  const alterarCargo = async (user_id: string, cargo: "Admin" | "Supervisor" | "Membro") => {
    try {
  ...
  const todosMembros = [...membros].sort((a, b) => a.nome.localeCompare(b.nome));
    ...
    <div className="mx-auto max-w-5xl space-y-8 p-8">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Pessoas da equipe com acesso a este workspace.
        </p>
      </header>
      ...
      {isAdmin && (
        <section className="space-y-3">
          ...
          <div className="overflow-hidden rounded-lg border border-border bg-white text-black shadow-sm">
            {pendentes.length === 0 ? (
              <div className="p-6 text-sm text-gray-600">Nenhum convite pendente.</div>
            ) : (
              pendentes.map((c) => (
                <div
                  key={c.id}
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          O convite é cancelado. Se essa pessoa tentar se cadastrar depois, vai
                          precisar de um novo convite.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
